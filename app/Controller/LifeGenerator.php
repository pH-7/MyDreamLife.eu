...
class LifeGenerator extends Base
{
    ...
    private function sendApplicationToAdmin(array $vars): bool
    {
        ...
        $message .= $this->getItineraryEmailBody($vars);
    ...
    private function getItineraryEmailBody(array $vars): string
    {
        $emailTemplate = $this->getItineraryEmailTemplate();
    ...
    private function getItineraryEmailTemplate(): string
    {
